...
# https://docs.microsoft.com/en-au/windows/win32/secauthn/tls-cipher-suites-in-windows-8-1
$windows2012r2Ciphers = @(
"TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P256",
"TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384",
"TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256",
"TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P384",
...
"GOST94-NULL-GOST94"="TLS_GOSTR341001_WITH_NULL_GOSTR3411"
#"GOST2001-GOST89-GOST89"="TLS_GOSTR341094_WITH_NULL_GOSTR3411"
...
"TLS_FALLBACK_SCSV"="TLS_EMPTY_RENEGOTIATION_INFO_SCSV"
...
"ECDHE-ECDSA-CAMELLIA256-SHA38"="TLS_ECDHE_ECDSA_WITH_CAMELLIA_256_CBC_SHA384"
...
"ECDHE-PSK-CAMELLIA128-SHA25"="TLS_ECDHE_PSK_WITH_CAMELLIA_128_CBC_SHA256"
"ECDHE-PSK-CAMELLIA256-SHA38"="TLS_ECDHE_PSK_WITH_CAMELLIA_256_CBC_SHA384"
...
write-host
write-host "Supported by website: $ciphers"
write-host
write-host "Supported by website (as IANA names): $converted"

$common = Get-TlsCipherSuite | % {$_.Name} | ? {$ciphers.Contains($_) -or $converted.Contains($_)}
...
Write-Host
Write-Host "Supported by Windows 2012 R2: $win2012r2"

$win2018r2 = $windows2008R2Ciphers | ? {$ciphers.Contains($_) -or $converted.Contains($_)}

Write-Host
Write-Host "Supported by Windows 2008 R2: $win2018r2"
